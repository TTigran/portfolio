...
const Navbar = ({onButtonClick, flag}) => {
    const [showMenu, setShowMenu] = useState(false)
    const mediaContext = useMediaContext();
    const sendTitleToVideoPlayer = (title) => {
        mediaContext.sendTitle(title);
    };
    ...
    return (
        <div
            ...
            {flag && <div className="search-div-header">
                <input onChange={(e) => sendTitleToVideoPlayer(e.target.value)} id="search-box"/>
            </div>}
            <div>
                        ...
                        <div className="flex flex-col gap-8 py-2 relative">
                            <div>
                                ...
                                <p className="text-sm text-gray-400 mt-2">
                                    "I am a Software Full stack engineer"
                                </p>
                            </div>
